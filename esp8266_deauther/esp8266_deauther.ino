/*
  ===========================================
       ...
       Duzenleyen(Edited By): Ege Bagcivan
  ===========================================
*/
...
void loop() {
  ...
  // ===== select ===== 
    ...
    // ===== start,stop attack ===== 
      ...
      if (attackMode == "BASLAT" && apScan.getFirstTarget() > -1) attack.start(0);
      else if (attackMode == "DURDUR") attack.stop(0);
    } 
